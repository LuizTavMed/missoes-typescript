...
test('Integration test', async () => {
  ...
  let res = await request(app.express).get('localhost:4000/api/logs')
  console.log('res:', res)
  res = await request(app.express).post('localhost:4000/api/logs')
  console.log('res:', res)
  res = await request(app.express).patch('localhost:4000/api/logs')
  console.log('res:', res)
  res = await request(app.express).delete('localhost:4000/api/logs')
  console.log('res:', res)
  beforeAll(async () => {
    dotenv.config()
